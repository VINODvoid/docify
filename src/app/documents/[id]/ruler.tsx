...
export const Ruler = () => {
  ...
  return (
    <div
      ...
      className="w-[816px] mx-auto h-6 border-b border-l-neutral-50 flex items-end relative select-none print:hidden"
    >
      <div
        id="ruler-container"
            ...
            {markers.map((marker) => {
              ...
              return (
                ...
                >
                  {marker % 10 === 0 && (
                    <>
                      <div className="absolute bottom-0 w-px h-2 bg-black" />
